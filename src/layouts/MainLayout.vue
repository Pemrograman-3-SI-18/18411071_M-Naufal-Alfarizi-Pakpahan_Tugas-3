            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  ...
                  <div>Dwi Romadon</div> -->
                  <div class="text-bold items-center">18411071</div>
                  <div>M. Naufal Alfarizi Pakpahan</div>
                </div>
              </div>
              ...
              <div class="column items-center">
                <q-btn flat round dense>
                  <q-avatar size="72px">
                    <img src="https://i.ibb.co/6YrZ8c3/DSC-0287.jpg" alt="DSC-0287" border="0">
                  </q-avatar>
                </q-btn>
          ...
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              <q-avatar size="100px" class="q-mb-md">
                <img src="https://i.ibb.co/6YrZ8c3/DSC-0287.jpg" alt="DSC-0287" >
              </q-avatar>
              <!-- <div class="text-weight-bold">13421054</div>
              <div>Dwi Romadon</div> -->
              <div class="text-weight-bold">18411071</div>
              <div>M. Naufal Alfarizi Pakpahan</div>
            </div>
          </q-item>
          <q-item-label
